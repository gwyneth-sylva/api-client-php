...
class StandardCompartment {
     ...
     * @var  array<StandardSubCompartment>
     */
...
Class StandardSubCompartment {
     ...
     * @var  array<StandardInventory>
     */
    public $inventory = [];

    /**
     * array of ground truth plots
     * @var  array<StandardPlot>
     */
    public $plots = [];
...
Class StandardInventory {
     ...
     * @var  array<StandardRepresentativeTree>
     */
